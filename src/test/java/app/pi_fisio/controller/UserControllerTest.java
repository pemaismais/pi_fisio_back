...
class UserControllerTest {
    ...
    void create() {//create 201
        ...
        UserDTO user1 = new UserDTO(1L, "fulano", "@gmail.com", UserRole.USER, "ingles", List.of(new JointIntensity(1L, Joint.SHOULDER, Intensity.HIGH, null), new JointIntensity(2L, Joint.KNEE, Intensity.MEDIUM, null)));
    ...
    void createBad() {
        ...
        UserDTO user1 = new UserDTO( 1L,"joana", "", UserRole.USER, "ingles", List.of(new JointIntensity(1L, Joint.SHOULDER, Intensity.HIGH, null), new JointIntensity(2L, Joint.KNEE, Intensity.MEDIUM, null)));
    ...
    @Test
    void update() { //200
        UserDTO userDto = new UserDTO(1L, "joansa", "@gmail.com", UserRole.ADMIN, "ingles",
    ...
    @Test
    void updateBad() { //400
        UserDTO userDto = new UserDTO(1L, "joansa", "", UserRole.ADMIN, "ingles",
                List.of(new JointIntensity(1L, Joint.SHOULDER, Intensity.HIGH, null),
                        new JointIntensity(2L, Joint.KNEE, Intensity.MEDIUM, null)));
    ...
    @Test
    void delete() { //200 OK
        UserDTO user1 = new UserDTO( 1L,"joana", "@gmail.com", UserRole.USER, "ingles", List.of(new JointIntensity(1L, Joint.SHOULDER, Intensity.HIGH, null), new JointIntensity(2L, Joint.KNEE, Intensity.MEDIUM, null)));
    ...
    void deleteBad() { //400 BAD
        UserDTO user1 = new UserDTO( null,"joana", "@gmail.com", UserRole.USER, "ingles", List.of(new JointIntensity(1L, Joint.SHOULDER, Intensity.HIGH, null), new JointIntensity(2L, Joint.KNEE, Intensity.MEDIUM, null)));
    ...
    void getAll() throws Exception {
        ...
        UserDTO user1 = new UserDTO(1L, "Joana", "joana@gmail.com", UserRole.USER, "Inglês",
                List.of(new JointIntensity(1L, Joint.SHOULDER, Intensity.HIGH, null),
                        new JointIntensity(2L, Joint.KNEE, Intensity.MEDIUM, null)));

        UserDTO user2 = new UserDTO(2L, "Carlos", "carlos@gmail.com", UserRole.ADMIN, "Francês",
                List.of(new JointIntensity(3L, Joint.LOWERBACK, Intensity.LOW, null),
                        new JointIntensity(4L, Joint.ANKLE, Intensity.HIGH, null)));

        UserDTO user3 = new UserDTO(3L, "Mariaa", "maria@gmail.com", UserRole.USER, "Espanhol",
                List.of(new JointIntensity(5L, Joint.HIP, Intensity.MEDIUM, null),
                        new JointIntensity(6L, Joint.ANKLE, Intensity.LOW, null)));

        UserDTO user4 = new UserDTO(4L, "Pedro", "pedro@gmail.com", UserRole.USER, "Alemão",
